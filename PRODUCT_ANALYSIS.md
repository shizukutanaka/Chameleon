...
all three configurations — **373 passed** on a bare install (stdlib only,
27 skipped), **445** with numpy (scipy/librosa/soundfile blocked, 27
skipped), **542** with numpy + scipy + librosa + soundfile + fastapi
