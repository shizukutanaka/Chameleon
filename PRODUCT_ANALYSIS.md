...
all three configurations — **561 passed** on a bare install (stdlib only,
49 skipped), **669** with numpy (scipy/librosa/soundfile blocked, 44
skipped), **788** with numpy + scipy + librosa + soundfile + fastapi
