...
all three configurations — **457 passed** on a bare install (stdlib only,
28 skipped), **528** with numpy (scipy/librosa/soundfile blocked, 30
skipped), **629** with numpy + scipy + librosa + soundfile + fastapi
