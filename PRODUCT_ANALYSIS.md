...
all three configurations — **360 passed** on a bare install (stdlib only,
25 skipped), **425** with numpy (scipy/librosa/soundfile blocked, 26
skipped), **522** with numpy + scipy + librosa + soundfile + fastapi
