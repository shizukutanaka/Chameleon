...
all three configurations — **379 passed** on a bare install (stdlib only,
27 skipped), **451** with numpy (scipy/librosa/soundfile blocked, 27
skipped), **548** with numpy + scipy + librosa + soundfile + fastapi
