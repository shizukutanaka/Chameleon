...
all three configurations — **434 passed** on a bare install (stdlib only,
28 skipped), **505** with numpy (scipy/librosa/soundfile blocked, 30
skipped), **606** with numpy + scipy + librosa + soundfile + fastapi
(4 skipped). Skip totals follow which extras are installed — e.g. the two
