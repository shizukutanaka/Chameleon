...
all three configurations — **367 passed** on a bare install (stdlib only,
27 skipped), **438** with numpy (scipy/librosa/soundfile blocked, 27
skipped), **535** with numpy + scipy + librosa + soundfile + fastapi
