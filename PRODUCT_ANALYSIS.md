...
all three configurations — **408 passed** on a bare install (stdlib only,
27 skipped), **480** with numpy (scipy/librosa/soundfile blocked, 28
skipped), **580** with numpy + scipy + librosa + soundfile + fastapi
