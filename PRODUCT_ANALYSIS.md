...
all three configurations — **333 passed** on a bare install (stdlib only,
23 skipped), **391** with numpy (scipy/librosa/soundfile blocked, 24
skipped), **482** with numpy + scipy + librosa + soundfile + fastapi
