...
all three configurations — **411 passed** on a bare install (stdlib only,
27 skipped), **483** with numpy (scipy/librosa/soundfile blocked, 28
skipped), **584** with numpy + scipy + librosa + soundfile + fastapi
