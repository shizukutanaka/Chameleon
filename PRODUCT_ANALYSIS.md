...
all three configurations — **365 passed** on a bare install (stdlib only,
27 skipped), **436** with numpy (scipy/librosa/soundfile blocked, 27
skipped), **533** with numpy + scipy + librosa + soundfile + fastapi
