...
all three configurations — **456 passed** on a bare install (stdlib only,
28 skipped), **527** with numpy (scipy/librosa/soundfile blocked, 30
skipped), **628** with numpy + scipy + librosa + soundfile + fastapi
