...
all three configurations — **397 passed** on a bare install (stdlib only,
27 skipped), **470** with numpy (scipy/librosa/soundfile blocked, 27
skipped), **570** with numpy + scipy + librosa + soundfile + fastapi
