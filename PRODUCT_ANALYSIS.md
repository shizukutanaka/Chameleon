...
all three configurations — **474 passed** on a bare install (stdlib only,
32 skipped), **553** with numpy (scipy/librosa/soundfile blocked, 32
skipped), **657** with numpy + scipy + librosa + soundfile + fastapi
