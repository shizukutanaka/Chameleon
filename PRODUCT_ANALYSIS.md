...
all three configurations — **422 passed** on a bare install (stdlib only,
27 skipped), **493** with numpy (scipy/librosa/soundfile blocked, 28
skipped), **594** with numpy + scipy + librosa + soundfile + fastapi
