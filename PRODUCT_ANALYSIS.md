...
all three configurations — **387 passed** on a bare install (stdlib only,
27 skipped), **459** with numpy (scipy/librosa/soundfile blocked, 27
skipped), **556** with numpy + scipy + librosa + soundfile + fastapi
