...
all three configurations — **505 passed** on a bare install (stdlib only,
38 skipped), **591** with numpy (scipy/librosa/soundfile blocked, 35
skipped), **698** with numpy + scipy + librosa + soundfile + fastapi
