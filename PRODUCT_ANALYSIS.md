...
all three configurations — **375 passed** on a bare install (stdlib only,
27 skipped), **447** with numpy (scipy/librosa/soundfile blocked, 27
skipped), **544** with numpy + scipy + librosa + soundfile + fastapi
