...
all three configurations — **568 passed** on a bare install (stdlib only,
49 skipped), **676** with numpy (scipy/librosa/soundfile blocked, 44
skipped), **795** with numpy + scipy + librosa + soundfile + fastapi
