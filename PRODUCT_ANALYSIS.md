...
all three configurations — **405 passed** on a bare install (stdlib only,
27 skipped), **478** with numpy (scipy/librosa/soundfile blocked, 27
skipped), **578** with numpy + scipy + librosa + soundfile + fastapi
