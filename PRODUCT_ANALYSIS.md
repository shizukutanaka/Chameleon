...
all three configurations — **507 passed** on a bare install (stdlib only,
38 skipped), **593** with numpy (scipy/librosa/soundfile blocked, 35
skipped), **700** with numpy + scipy + librosa + soundfile + fastapi
