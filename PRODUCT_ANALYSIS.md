...
all three configurations — **402 passed** on a bare install (stdlib only,
27 skipped), **475** with numpy (scipy/librosa/soundfile blocked, 27
skipped), **575** with numpy + scipy + librosa + soundfile + fastapi
