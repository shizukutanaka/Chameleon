...
all three configurations — **389 passed** on a bare install (stdlib only,
27 skipped), **461** with numpy (scipy/librosa/soundfile blocked, 27
skipped), **558** with numpy + scipy + librosa + soundfile + fastapi
