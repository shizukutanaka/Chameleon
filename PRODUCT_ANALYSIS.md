...
all three configurations — **382 passed** on a bare install (stdlib only,
27 skipped), **454** with numpy (scipy/librosa/soundfile blocked, 27
skipped), **551** with numpy + scipy + librosa + soundfile + fastapi
