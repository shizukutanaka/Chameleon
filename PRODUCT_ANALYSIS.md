...
33 skipped), **557** with numpy (scipy/librosa/soundfile blocked, 35
skipped), **664** with numpy + scipy + librosa + soundfile + fastapi
(5 skipped, plus one known intermittent SIGINT timing flake). Skip totals follow which extras are installed — e.g. the two
