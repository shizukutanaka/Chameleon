...
all three configurations — **416 passed** on a bare install (stdlib only,
27 skipped), **487** with numpy (scipy/librosa/soundfile blocked, 28
skipped), **588** with numpy + scipy + librosa + soundfile + fastapi
