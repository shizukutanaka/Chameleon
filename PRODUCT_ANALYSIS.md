...
all three configurations — **368 passed** on a bare install (stdlib only,
27 skipped), **439** with numpy (scipy/librosa/soundfile blocked, 27
skipped), **536** with numpy + scipy + librosa + soundfile + fastapi
