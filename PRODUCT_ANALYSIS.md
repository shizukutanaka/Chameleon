...
all three configurations — **376 passed** on a bare install (stdlib only,
27 skipped), **448** with numpy (scipy/librosa/soundfile blocked, 27
skipped), **545** with numpy + scipy + librosa + soundfile + fastapi
