...
all three configurations — **464 passed** on a bare install (stdlib only,
36 skipped), **546** with numpy (scipy/librosa/soundfile blocked, 34
skipped), **652** with numpy + scipy + librosa + soundfile + fastapi
