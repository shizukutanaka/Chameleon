...
all three configurations — **390 passed** on a bare install (stdlib only,
27 skipped), **462** with numpy (scipy/librosa/soundfile blocked, 27
skipped), **559** with numpy + scipy + librosa + soundfile + fastapi
