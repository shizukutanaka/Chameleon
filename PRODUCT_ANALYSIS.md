...
all three configurations — **403 passed** on a bare install (stdlib only,
27 skipped), **476** with numpy (scipy/librosa/soundfile blocked, 27
skipped), **576** with numpy + scipy + librosa + soundfile + fastapi
