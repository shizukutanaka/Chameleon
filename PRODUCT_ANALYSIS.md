...
all three configurations — **386 passed** on a bare install (stdlib only,
27 skipped), **458** with numpy (scipy/librosa/soundfile blocked, 27
skipped), **555** with numpy + scipy + librosa + soundfile + fastapi
