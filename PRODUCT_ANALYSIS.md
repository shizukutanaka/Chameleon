...
all three configurations — **421 passed** on a bare install (stdlib only,
27 skipped), **492** with numpy (scipy/librosa/soundfile blocked, 28
skipped), **593** with numpy + scipy + librosa + soundfile + fastapi
