...
all three configurations — **363 passed** on a bare install (stdlib only,
27 skipped), **428** with numpy (scipy/librosa/soundfile blocked, 27
skipped), **525** with numpy + scipy + librosa + soundfile + fastapi
