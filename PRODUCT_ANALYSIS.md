...
all three configurations — **461 passed** on a bare install (stdlib only,
29 skipped), **533** with numpy (scipy/librosa/soundfile blocked, 30
skipped), **634** with numpy + scipy + librosa + soundfile + fastapi
