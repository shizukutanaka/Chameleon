...
**Version:** 1.1.0 · **Tests:** re-run 2026-09-26 on Python 3.12, in
...
skipped), **664 + 1 intermittent SIGINT-timing flake** with numpy +
scipy + librosa + soundfile + fastapi (5 skipped). Skip totals follow which extras are installed — e.g. the two
