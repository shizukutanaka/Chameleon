...
all three configurations — **417 passed** on a bare install (stdlib only,
27 skipped), **488** with numpy (scipy/librosa/soundfile blocked, 28
skipped), **589** with numpy + scipy + librosa + soundfile + fastapi
