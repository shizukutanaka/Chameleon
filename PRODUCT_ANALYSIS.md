...
all three configurations — **413 passed** on a bare install (stdlib only,
27 skipped), **484** with numpy (scipy/librosa/soundfile blocked, 28
skipped), **585** with numpy + scipy + librosa + soundfile + fastapi
