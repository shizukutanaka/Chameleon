...
all three configurations — **468 passed** on a bare install (stdlib only,
31 skipped), **544** with numpy (scipy/librosa/soundfile blocked, 32
skipped), **648** with numpy + scipy + librosa + soundfile + fastapi
