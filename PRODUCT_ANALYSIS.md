...
all three configurations — **352 passed** on a bare install (stdlib only,
23 skipped), **415** with numpy (scipy/librosa/soundfile blocked, 24
skipped), **506** with numpy + scipy + librosa + soundfile + fastapi
