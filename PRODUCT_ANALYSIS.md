...
all three configurations — **410 passed** on a bare install (stdlib only,
27 skipped), **482** with numpy (scipy/librosa/soundfile blocked, 28
skipped), **582** with numpy + scipy + librosa + soundfile + fastapi
