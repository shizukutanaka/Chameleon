...
all three configurations — **415 passed** on a bare install (stdlib only,
27 skipped), **486** with numpy (scipy/librosa/soundfile blocked, 28
skipped), **587** with numpy + scipy + librosa + soundfile + fastapi
