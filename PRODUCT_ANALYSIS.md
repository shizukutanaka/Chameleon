...
all three configurations — **374 passed** on a bare install (stdlib only,
27 skipped), **446** with numpy (scipy/librosa/soundfile blocked, 27
skipped), **543** with numpy + scipy + librosa + soundfile + fastapi
