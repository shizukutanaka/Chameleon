...
all three configurations — **418 passed** on a bare install (stdlib only,
27 skipped), **489** with numpy (scipy/librosa/soundfile blocked, 28
skipped), **590** with numpy + scipy + librosa + soundfile + fastapi
