...
all three configurations — **517 passed** on a bare install (stdlib only,
41 skipped), **609** with numpy (scipy/librosa/soundfile blocked, 36
skipped), **718** with numpy + scipy + librosa + soundfile + fastapi
