...
all three configurations — **460 passed** on a bare install (stdlib only,
28 skipped), **531** with numpy (scipy/librosa/soundfile blocked, 30
skipped), **632** with numpy + scipy + librosa + soundfile + fastapi
