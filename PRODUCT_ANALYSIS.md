...
all three configurations — **420 passed** on a bare install (stdlib only,
27 skipped), **491** with numpy (scipy/librosa/soundfile blocked, 28
skipped), **592** with numpy + scipy + librosa + soundfile + fastapi
