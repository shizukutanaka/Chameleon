...
all three configurations — **404 passed** on a bare install (stdlib only,
27 skipped), **477** with numpy (scipy/librosa/soundfile blocked, 27
skipped), **577** with numpy + scipy + librosa + soundfile + fastapi
