...
all three configurations — **401 passed** on a bare install (stdlib only,
27 skipped), **474** with numpy (scipy/librosa/soundfile blocked, 27
skipped), **574** with numpy + scipy + librosa + soundfile + fastapi
