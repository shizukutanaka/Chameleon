...
all three configurations — **354 passed** on a bare install (stdlib only,
25 skipped), **417** with numpy (scipy/librosa/soundfile blocked, 26
skipped), **512** with numpy + scipy + librosa + soundfile + fastapi
