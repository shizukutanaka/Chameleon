...
all three configurations — **400 passed** on a bare install (stdlib only,
27 skipped), **473** with numpy (scipy/librosa/soundfile blocked, 27
skipped), **573** with numpy + scipy + librosa + soundfile + fastapi
