"""
MyCustomEffect Plugin for Chameleon Audio Processing System
...
class MyCustomEffectPlugin(AudioEffectPlugin):
    """
    MyCustomEffect - A Chameleon audio processing plugin
    """
    ...
    def get_metadata(self) -> PluginMetadata:
        return PluginMetadata(
            ...
            description="Description of MyCustomEffect plugin",
            category="effect",
            tags=["effect", "audio"],
            parameters={
                "gain": {
